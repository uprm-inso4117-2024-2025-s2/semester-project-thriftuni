...
export default function ListingDescription({description}: {description:string}) {
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={{fontSize:18, fontWeight: '500', fontStyle: 'italic', color: 'black'}}>Description</Text>
            <View style={styles.infoBox}>
                <Text style={styles.descriptionText}>Description goes here: {description}</Text>
            </View>
            <Text style={{fontSize:18, fontWeight:'500', fontStyle:'italic',color:'black'}}>Location</Text>
            <View style={styles.infoBox}>
                <LocationMap {...locationInfo}/>
            </View>
            <Text style={{fontSize:18, fontWeight:'500', fontStyle:'italic',color:'black'}}>About the seller</Text> 
            <View style={styles.infoBox}>
